...
--upload-file /var/lib/jenkins/workspace/scriptedpl-web-app-deployment/target/maven-web-application.war \
"http://13.206.88.20:9090/manager/text/deploy?path=/maven-web-application&update=true"
